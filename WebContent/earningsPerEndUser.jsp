...
<body>
	...
	<!-- To include 
	SELECT item.created_by, SUM(auction.curr_price) as earnings_per_seller FROM auction INNER JOIN item ON auction.item_id = item.item_id AND auction.cat_id = item.cat_id AND auction.subcat_id = item.subcat_id WHERE closing_time < NOW() GROUP BY item.created_by ORDER BY earnings_per_seller DESC
	 -->
<div class="container">
